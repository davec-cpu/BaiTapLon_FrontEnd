...
function DanhSachDanhGiaDauBep() {
    ...
    useEffect(() => { 
        ...
        const urlDsDanhGia = `http://127.0.0.1:8000/api/daubepchebien/laydanhsachdanhgia/${localStorage.getItem('idAdmin')}`
...
export default DanhSachDanhGiaDauBep
